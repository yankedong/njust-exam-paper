...
\begin{document}
%%%%%%%%%%%%%%%%% 以下内容根据需要更改%%%%%%%%%%%
\renewcommand{\course}{大数据安全与分析}                          %课程名
\renewcommand{\duration}{100}                                            %考试时长
\renewcommand{\credit}{3}                                                   %学分
\renewcommand{\syllabus}{060337601-0}                               %教学大纲编号
\renewcommand{\fullmark}{100}                                            %满分分值
\renewcommand{\composer}{颜克冬}            %组卷教师
\renewcommand{\composedate}{2021年11月28日}                   %组卷日期
\renewcommand{\validator}{颜克冬}                                        %审定人
